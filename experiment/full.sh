...
e Publish $logs/21-cv-all-publish.log
s $wait_interval
...
e PromoteCV1 $logs/23-cv-all-promote-1.log
s $wait_interval
...
e PromoteCV2 $logs/23-cv-all-promote-2.log
s $wait_interval
...
e PromoteCV3 $logs/23-cv-all-promote-3.log
s $wait_interval
...
e RepoSyncRhel7 $logs/12b-repo-sync-rhel7.log
...
e RepoSyncRhel6 $logs/12b-repo-sync-rhel6.log
...
e RepoSyncRhel7Optional $logs/12b-repo-sync-rhel7optional.log
wait
s $wait_interval
